...
export const shareVideoWithNavigator = ({ title, url,  performer }) => {
    let text = `
    Kepada Yth.
Bapak/Ibu/Saudara/i
*${performer}*
  
*Shalom, Salam Sejahtera dalam kasih,*
...
Tanpa mengurangi rasa hormat, perkenankan kami mengundang Bapak/Ibu/Saudara/i *${performer}* untuk menghadiri acara kami.
    
*Berikut link undangan untuk info lengkap dari acara kami :*
${url}
    
note:
(mohon ganti browser jika musik tidak muncul pada browser anda)
